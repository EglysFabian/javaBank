...
public class Main {
    ...
    public static void funcoes() {
        ...
        switch(funcao) {
            ...
            case 5:
                ...
                break;
            case 6:
                System.out.println("Obrigado por utilizar o nosso banco, sistema finalizado.");
                System.exit(0);
            default:
    ...
    public static void transferir(){
        System.out.println("Número da quem irá enviar: ");
        int numeroContaRemetente = input.nextInt();
        
        Conta contaRemetente = encontrarConta(numeroContaRemetente);
        
        if(contaRemetente != null) {
            System.out.println("Número da quem irá receber: ");
